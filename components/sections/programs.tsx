...
const programs = [
  {
    age: "Pre A1 / A1",
    title: "Starters",
    description: "Мягкий вход в язык: ребёнок начинает понимать речь и уверенно отвечать короткими фразами.",
    features: [
  ...
  },
  {
    age: "A1 / A2",
    title: "Movers",
    description: "Укрепляем базу и расширяем речь: ребёнок увереннее строит фразы и лучше понимает задания.",
    features: [
  ...
  },
  {
    age: "A2 / A2+",
    title: "Flyers",
    description: "Выводим речь на устойчивый уровень: уверенное говорение, письмо и подготовка к A2+.",
    features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
            Каждая ступень имеет чёткие цели по речи, чтению, письму и
            аудированию. Двигаемся по международной шкале CEFR в комфортном
            темпе для ребёнка.
          </p>
        </div>
