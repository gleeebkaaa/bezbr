...
const programs = [
  {
    age: "Pre A1 / A1",
    title: "Starters",
    description: "Первый устойчивый шаг в английский: ребёнок понимает простую речь, отвечает короткими фразами и не боится говорить.",
    features: [
  ...
  },
  {
    age: "A1 / A2",
    title: "Movers",
    description: "Укрепляем базу: ребёнок строит более длинные фразы, лучше понимает задания и начинает увереннее читать.",
    features: [
  ...
  },
  {
    age: "A2 / A2+",
    title: "Flyers",
    description: "Выводим язык на устойчивый уровень: больше самостоятельной речи, письма, проектов и подготовки к A2+.",
    features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
            Каждая ступень развивает речь, чтение, письмо и аудирование.
            Двигаемся по международной шкале CEFR, регулярно проверяем прогресс
            и показываем родителям, что уже получается.
          </p>
        </div>
