...
const advantages = [
  ...
  },
  {
    ...
    description: "Индивидуально, в паре или в мини-группе — подбираем формат и темп без перегруза."
  },
  {
    icon: MapPin,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
            Ребёнку интересно и комфортно, а родитель понимает, как именно
            строится обучение и куда движется результат.
          </p>
        </div>
