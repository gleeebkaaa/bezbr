          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
              <p>
                ...
                говорить, пробовать и постепенно выходить в уверенную речь.
              </p>
              <p>
                Мы работаем по уровням CEFR и программам Cambridge Young
                Learners (Starters, Movers, Flyers). Для ребёнка это
                интересные занятия с вовлечением, для родителей — понятный
                маршрут и измеримый прогресс.
              </p>
              <p>
                На занятиях ребёнок осваивает язык и одновременно развивает
                мышление, гибкость, внимание и навыки взаимодействия с другими.
              </p>
            </div>
          </div>
