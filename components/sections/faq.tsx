...
const faqs = [
  {
    ...
    answer: "Мы начинаем работать с детьми от 3,5 лет. На старте подбираем формат, в котором ребёнку будет комфортно включиться в английский: индивидуально, в паре или в мини-группе."
  },
  {
  ...
  },
  {
    ...
    answer: "Да. Знание букв — только первый шаг. Для чтения нужен навык соединения звуков, понимание структуры слова и регулярная практика. Мы развиваем этот навык поэтапно и без перегруза."
  },
  {
    question: "Ребёнок боится говорить по-английски. Что делать?",
    answer: "Сначала снимаем страх ошибки и создаём безопасную атмосферу. Когда ребёнок не боится быть несовершенным, речь запускается быстрее. Мы не давим и не стыдим, а доводим до уверенного «могу сказать»."
  },
  {
