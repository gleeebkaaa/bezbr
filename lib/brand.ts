export const brand = {
  ...
  subtitle:
    "Детская языковая мастерская в Москве, где английский становится для ребёнка живым способом общаться, играть, узнавать мир и говорить без страха ошибки.",
...
export const heroHighlights = [
  ...
  "Старт обучения от 3,5 лет",
  "Очно, онлайн, индивидуально и в мини-группе",
]
