export const brand = {
  ...
  subtitle:
    "Занятия для детей от 3,5 лет: ребёнок начинает говорить свободнее, а родители видят реальный прогресс по понятным шагам.",
...
export const heroHighlights = [
  ...
  "Очно, онлайн, индивидуально, в паре и мини-группе",
]
