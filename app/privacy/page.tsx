...
const sections = [
  ...
  {
    title: "Как связаться",
    text: `Есть вопросы о защите данных или хотите записать ребёнка на пробное занятие? Напишите на ${brand.supportEmail} или позвоните ${brand.phone}.`,
  },
]
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="space-y-6">
              ...
              <p className="max-w-2xl text-lg leading-relaxed text-muted-foreground">
                Вы можете сосредоточиться на прогрессе ребёнка в английском:
