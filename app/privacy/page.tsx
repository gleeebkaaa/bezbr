...
const sections = [
  {
    ...
    text: "Имя, номер телефона, e-mail и текст сообщения, если вы оставляете заявку, а также данные заказа материалов, если оформляете покупку.",
  },
  {
    title: "Зачем мы их используем",
    text: "Чтобы связаться с вами, записать ребёнка на занятие, отправить материалы после покупки и ответить на вопросы по обучению.",
  },
  {
    title: "Как храним данные",
    text: "Мы используем их только для работы с обращением и не передаём третьим лицам без необходимости, связанной с исполнением заявки.",
  },
  {
    title: "Как связаться",
          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="space-y-6">
              ...
              <p className="max-w-2xl text-lg leading-relaxed text-muted-foreground">
                На сайте {brand.name} мы используем контактные данные только для
                обратной связи, записи на занятия и отправки материалов после
                покупки.
              </p>
            </div>
